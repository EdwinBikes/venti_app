...
class TotalCashRegisterScreen extends StatefulWidget {
  static const name = 'totalcashregister-screen';
  const TotalCashRegisterScreen({Key? key}) : super(key: key);

  @override
  State<TotalCashRegisterScreen> createState() =>
      _TotalCashRegisterScreenState();
}

class _TotalCashRegisterScreenState extends State<TotalCashRegisterScreen> {
          ...
          children: [
            ...
            AnimatedPages(
              ...
              child: (index, _) => MovieDetails(
                customImage: Image.asset('assets/images/CashRgs.png'),
                movies[index],
              ),
            ),
            Padding(
